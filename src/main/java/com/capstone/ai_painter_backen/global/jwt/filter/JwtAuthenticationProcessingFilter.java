package com.capstone.ai_painter_backen.global.jwt.filter;

import com.capstone.ai_painter_backen.domain.UserEntity;
import com.capstone.ai_painter_backen.global.jwt.service.JwtService;
import com.capstone.ai_painter_backen.global.jwt.util.PasswordUtil;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    private static final String NO_CHECK_URL2 = "/user/sign-up"; // "/login"으로 들어오는 요청은 Filter 작동 X
    ...
    public void saveAuthentication(UserEntity myUser) {
        log.info("saveAuthentication() 호출 userInfo: { }", myUser.toString());
