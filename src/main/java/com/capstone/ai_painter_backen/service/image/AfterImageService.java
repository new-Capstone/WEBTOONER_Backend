...
public class AfterImageService {
    ...
    AfterImageMapper afterImageMapper;
    AfterImageRepository afterImageRepository;
    ...
    public AfterImageDto.ResponseDto readAfterImage(Long afterImageId){
    ...
    public List<AfterImageDto.ResponseDto> createAfterImageList(Long beforeImageId, List<MultipartFile> afterImages) {
